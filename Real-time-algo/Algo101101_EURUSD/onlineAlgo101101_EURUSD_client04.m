function [topicPub,messagePub] = onlineAlgo101101_EURUSD_client04(topicSub,messageSub,password)
...
nameAlgo          = 'Algo101100_AUDCAD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@AUDCAD@101100';
algoMagic         = 101100;
nData             = 100;
operLots          = 1;
...
listener3 = strcmp(topicSub,'STATUS@AUDCAD@101100');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && ms.statusNotification == 0 )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn, real] = Algo101100_stocOsc_AUDCAD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
