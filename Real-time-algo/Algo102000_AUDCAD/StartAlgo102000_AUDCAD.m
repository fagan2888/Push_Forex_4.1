function StartAlgo102000_AUDCAD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers102000_AUDCAD.txt');
...
fileIdSub = fopen('configListeners102000_AUDCAD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo102000_AUDCAD_client04(topicName,messageBody,password);
