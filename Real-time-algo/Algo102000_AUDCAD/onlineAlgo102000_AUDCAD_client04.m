function [topicPub,messagePub] = onlineAlgo102000_AUDCAD_client04(topicSub,messageSub,password)
...
nameAlgo          = 'Algo102000_AUDCAD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@AUDCAD@102000';
algoMagic         = 102000;
nData             = 100;
operLots          = 1;
...
listener3 = strcmp(topicSub,'STATUS@AUDCAD@102000');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && ms.statusNotification == 0 )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn, real] = Algo102000_min_max_reverting_AUDCAD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
