function StartAlgo102200_EURUSD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers102200_EURUSD.txt');
...
fileIdSub = fopen('configListeners102200_EURUSD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo102200_EURUSD_client04(topicName,messageBody,password);
