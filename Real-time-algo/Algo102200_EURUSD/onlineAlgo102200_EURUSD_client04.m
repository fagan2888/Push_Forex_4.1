function [topicPub,messagePub] = onlineAlgo102200_EURUSD_client04(topicSub,messageSub,password)
...
nameAlgo          = 'Algo102200_EURUSD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@EURUSD@102200';
algoMagic         = 102200;
nData             = 100;
operLots          = 1;
...
listener1 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m5@v100');
listener2 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m1@v1');
listener3 = strcmp(topicSub,'STATUS@EURUSD@102200');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && ms.statusNotification == 0 )
    t=now;
    timeMin=t*60*24;
    [oper, openValue, closeValue, stopLoss, takeProfit, minReturn, real] = Algo102200_forex_alligator_EURUSD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
