classdef bkt_fast_020b_2_min_max_reverting_con_trendline_real < handle
    ...
    methods
        ...
        function obj = spin(obj, Pminute, matrixNewHisData, ~, newTimeScale, N, jump, cost, ~, ~, wTP, ~, plottami)
            ...
            % Usa un fit lineare x determinare il trend del prezzo del
            % medio periodo e opera solo se l'operazione segue il trend.
            % Usa il decisionmaker realZigZag che metter real=0 dopo
            ...
            for z = 101:sizeStorico
                ...
                if P(z) > massimo && massimo-minimo>jump
                    fitline = polyfit(ics',P(z-2*N+1:z),1);
                    if fitline(1)<0
                        s(z) = -1;
                    end
