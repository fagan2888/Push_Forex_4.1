classdef bkt_fast_020b_min_max_reverting_con_trendline_3D < handle
    ...
    methods
        ...
        function obj = spin(obj, Pminute, matrixNewHisData, ~, newTimeScale, N, jump, cost, ~, ~, wTP, ~, M)
            ...
            % M = lookback period per calcolare la volatilita'
