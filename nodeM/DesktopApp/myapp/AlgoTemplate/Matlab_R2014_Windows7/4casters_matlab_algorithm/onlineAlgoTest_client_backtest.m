...
persistent opTicket;
listener1 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m1@v5');
listener2 = strcmp(topicSub,'STATUS@EURUSD@9999');
...
if listener1 == 1
    if r == 2
        ...
        topicPub = 'OPERATIONS@ACTIVTRADES@EURUSD@9999';
        if opOpen == 1
            %close position
        ...
        elseif opOpen == 0
            ...
            topicPub = 'SKIP@ACTIVTRADES@EURUSD@9999';
            messagePub = 'SKIP';
        end
    else
        display('SKIP operation');
