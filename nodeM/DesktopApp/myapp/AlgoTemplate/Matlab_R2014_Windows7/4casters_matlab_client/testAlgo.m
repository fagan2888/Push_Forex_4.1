...
while ready
    ...
    if listener2 == 1
        ...
        executionStringParamsPartial = sprintf('C:\\Users\\FX64\\Desktop\\matlab_algo_1474108596023\\TEST1\\for_redistribution_files_only\\TEST1.exe 127.0.0.1 %s %s ',pubPortStartBacktest,subPortStartBacktest);
