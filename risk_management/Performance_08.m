classdef Performance_08 < handle
    ...
    methods
        ...
        function obj=calcSinglePerformance(obj,origin,parameters,inputResultsMatrix)
            ...
            % initialStack         ... starting money
            % leverage             ... leverage to use in the real Algo
            ...
            % p = Performance_08;
            % p = p.calcSinglePerformance('bktWeb',parameters,obj.outputBktOffline); 
            % p = Performance_07;
            ...
            obj.inputResultsMatrix=inputResultsMatrix;
        ...
        function obj=calcPortfolioPerformance(obj)
